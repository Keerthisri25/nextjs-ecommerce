            ...
            <p className="text-black font-bold">${getItemTotal(item.id).toFixed(2)}</p>
              <div className="flex items-center justify-between md:order-3 md:justify-end">
                <div className="flex items-center">
                  ...
                  <button onClick={() => increaseQty(item.id)} className="m-0.3 pt-0.8 pb-0.8 pl-2 pr-2 text-black border rounded cursor-pointer hover:bg-gray-900 hover:text-white">+</button>
                </div>
              </div>
          </div>
        ))
